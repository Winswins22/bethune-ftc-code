...
@Autonomous(name = "ImageRec", group = "Concept")

public class ImageRec extends LinearOpMode {
    /*
     * Note: This sample uses the all-objects Tensor Flow model
     * (FreightFrenzy_BCDM.tflite), which contains
     ...
     *
     * Two additional model assets are available which only contain a subset of the
     * objects:
